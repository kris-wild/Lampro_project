##########################################################
##### CTMAX & TPREF EXPERIMENTAL ANALYSIS & Figure ####### 
##########################################################
## Packages
pacman::p_load(lme4,tidyverse, latex2exp, performance, plotrix, ggforce, cowplot, emmeans, ggpubr, data.table, rstatix)
...
#############################################
# FIGURE 1: Thermal Figure (Tpref & CTmax) # 
#############################################
...
# Figure 1 Final - Combining both plots
